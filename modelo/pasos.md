...
docker run --rm -v "$(pwd)/modelos_cnn:/app/4modelos_cnn" omargo33/trainer-final:1.0.7
docker push omargo33/trainer-final:1.0.7

docker build -t omargo33/front-final:1.0.7 -f Dockerfile.front .
docker run --rm -p 8501:8501 -v "$(pwd)/modelos_cnn:/app/modelos_cnn" omargo33/front-final:1.0.7
docker push omargo33/front-final:1.0.5
